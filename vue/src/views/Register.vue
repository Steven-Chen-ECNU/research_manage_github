<template>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #1450aa">欢 迎 注 册
      </div>
...
.login-container {
  ...
  align-items: center;
  background: linear-gradient(to top, #2c5a87, #408c8c, #5d8c84);
}
