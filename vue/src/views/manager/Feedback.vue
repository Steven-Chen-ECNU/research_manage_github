<template>
    <div>
        <div class="card" style="margin-bottom: 5px">
            <el-input v-model="data.teacherName" prefix-icon="Search" style="width: 240px; margin-right: 10px"
                placeholder="请输入教师名称查询"></el-input>
        ...
        <el-dialog title="回复信息" v-model="data.formVisible" width="40%" destroy-on-close>
            <el-form ref="form" :model="data.form" label-width="70px" style="padding: 20px">
                <el-form-item prop="replyContent" label="回复内容">
                    <el-input type="textarea" :rows="4" v-model="data.form.replyContent"
